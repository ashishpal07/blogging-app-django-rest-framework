...
def unique_slugify(model, base_text: str, slug_field: str = "slug", max_length: int = 201) -> str:
...
def is_liked_by_user(user, *, post_id: Optional[int] = None, comment_id: Optional[int] = None) -> bool:
  if not user or not user.is_authenticated:
    return False
